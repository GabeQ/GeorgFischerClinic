...
%.obj: ../%.c $(GEN_OPTS) | $(GEN_FILES)
	...
	"C:/ti/ccsv8/tools/compiler/ti-cgt-arm_18.1.3.LTS/bin/armcl" -mv7M3 --code_state=16 --float_support=vfplib -me --include_path="C:/Users/gquiroz/Documents/GitHub/GeorgFischerClinic/ble_workspace_v8/clock_CC2650_LAUNCHXL_TI_CC2650F128" --include_path="C:/Users/gquiroz/Documents/GitHub/GeorgFischerClinic/ble_workspace_v8/clock_CC2650_LAUNCHXL_TI_CC2650F128" --include_path="C:/ti/tirtos_cc13xx_cc26xx_2_20_01_08/products/cc26xxware_2_24_02_17393" --include_path="C:/ti/ccsv8/tools/compiler/ti-cgt-arm_18.1.3.LTS/include" --define=ccs -g --diag_warning=225 --diag_warning=255 --diag_wrap=off --display_error_number --gen_func_subsections=on --abi=eabi --preproc_with_compile --preproc_dependency="$(basename $(<F)).d_raw" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

build-1615022113:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1615022113-inproc

build-1615022113-inproc: ../clock.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1615022113 ../clock.cfg
configPkg/compiler.opt: build-1615022113
configPkg/: build-1615022113
